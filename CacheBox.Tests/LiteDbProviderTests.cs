...
public class LiteDbProviderTests
{
    ...
    public static void ClassInitialize(TestContext _)
    {
        string jsonConfig = @"{
                ""Cache"": {
                    ""AppPrefix"": ""LiteDbProviderTests"",
                    ""ConnectionString"": ""Filename=D:\\database.db;Connection=shared"",
                    ""Timeout"": ""0:0:10""
                }
            }";
        ...
        hostBuilder.AddCacheProvider<LiteDbCacheProvider>();
